...
def train(args):
    ...
    bert_pretained = './bert-base-uncased'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_dir', type=str,
                        default='/home/yanking/nizepu/CLUE/baselines/models_pytorch/mrc_pytorch/mrc_data/CMRC2018/train_features_512.json')
    parser.add_argument('--dev_dir1', type=str,
                        default='/home/yanking/nizepu/CLUE/baselines/models_pytorch/mrc_pytorch/mrc_data/CMRC2018/dev_examples_512.json')
    parser.add_argument('--dev_dir2', type=str,
                        default='/home/yanking/nizepu/CLUE/baselines/models_pytorch/mrc_pytorch/mrc_data/CMRC2018/dev_features_512.json')
    parser.add_argument('--train_file', type=str,
                        default='/home/yanking/nizepu/CLUE/baselines/models_pytorch/mrc_pytorch/mrc_data/CMRC2018/train.json')
    parser.add_argument('--dev_file', type=str,
                        default='/home/yanking/nizepu/CLUE/baselines/models_pytorch/mrc_pytorch/mrc_data/CMRC2018/dev.json')
    parser.add_argument('--bert_config_file', type=str,
                        default='/home/yanking/nizepu/CLUE/baselines/models_pytorch/mrc_pytorch/check_points/pretrain_models/bert_wwm_ext/bert_config.json')
    parser.add_argument('--vocab_file', type=str,
                        default='/home/yanking/nizepu/CLUE/baselines/models_pytorch/mrc_pytorch/check_points/pretrain_models/bert_wwm_ext/vocab.txt')
    parser.add_argument('--init_restore_dir', type=str,
                        default='/home/yanking/nizepu/CLUE/baselines/models_pytorch/mrc_pytorch/check_points/pretrain_models/bert_wwm_ext/pytorch_model.bin')
    parser.add_argument('--checkpoint_dir', type=str,
                        default='/home/yanking/nizepu/CLUE/baselines/models_pytorch/mrc_pytorch/check_points/CMRC2018/bert_wwm_ext/')
