...
export BERT_DIR=$OUTPUT_DIR/pretrain_models/$MODEL_NAME
...
python run_mrc.py \
  ...
  --init_restore_dir=$BERT_DIR/bert_model.pth \
...
#  --vocab_file=$BERT_DIR/vocab.txt \
#  --bert_config_file=$BERT_DIR/bert_config.json \
#  --init_restore_dir=$OUTPUT_DIR/$TASK_NAME/$MODEL_NAME/pytorch_model.bin \
